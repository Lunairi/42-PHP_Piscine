        ...
        foreach ($basket as $key => $arg) 
        {
            ...
            if ($cart && !$disp)
            {
                ...
                if ($basket[$key]['soil1'] > 0)
                {
                    ...
                    echo '<tr><td>' . $data['soil1'] . '</td><td>' . $basket[$key]['soil1'] . '</td><td> $' . $data['soil1p'] . '</td><td> $' . $price1 . '</td></tr>';
                }
                if ($basket[$key]['soil2'] > 0)
                {
                    $price2 = $basket[$key]['soil2'] * $data['soil2p'];
                    echo '<tr><td>' . $data['soil2'] . '</td><td>' . $basket[$key]['soil2'] . '</td><td> $' . $data['soil2p'] . '</td><td> $' . $price2 . '</td></tr>';
                }
                if ($basket[$key]['soil3'] > 0)
                {
                    $price3 = $basket[$key]['soil3'] * $data['soil3p'];
                    echo '<tr><td>' . $data['soil3'] . '</td><td>' . $basket[$key]['soil3'] . '</td><td> $' .$data['soil3p'] . '</td><td> $' . $price3 . '</td></tr>';
                }
                if ($basket[$key]['soil4'] > 0)
                {
                    $price4 = $basket[$key]['soil4'] * $data['soil4p'];
                    echo '<tr><td>' . $data['soil4'] . '</td><td>' . $basket[$key]['soil4'] . '</td><td> $' . $data['soil4p'] . '</td><td> $' . $price4 . '</td></tr>';
                }
                if ($basket[$key]['soil5'] > 0)
                {
                    $price5 = $basket[$key]['soil5'] * $data['soil5p'];
                    echo '<tr><td>' . $data['soil5'] . '</td><td>' . $basket[$key]['soil5'] . '</td><td> $' . $data['soil5p'] . '</td><td> $' . $price5 . '</td></tr>';
                }
                if ($basket[$key]['soil6'] > 0)
                {
                    $price6 = $basket[$key]['soil6'] * $data['soil6p'];
                    echo '<tr><td>' . $data['soil6'] . '</td><td>' . $basket[$key]['soil6'] . '</td><td> $' . $data['soil6p'] . '</td><td> $' . $price6 . '</td></tr>';
                }
                if ($basket[$key]['soil7'] > 0)
                {
                    $price7 = $basket[$key]['soil7'] * $data['soil7p'];
                    echo '<tr><td>' . $data['soil7'] . '</td><td>' . $basket[$key]['soil7'] . '</td><td> $' . $data['soil7p'] . '</td><td> $' . $price7 . '</td></tr>';
                }
                if ($basket[$key]['soil8'] > 0)
                {
                    $price8 = $basket[$key]['soil8'] * $data['soil8p'];
                    echo '<tr><td>' . $data['soil8'] . '</td><td>' . $basket[$key]['soil8'] . '</td><td> $' . $data['soil8p'] . '</td><td> $' . $price8 . '</td></tr>';
                }
                if ($basket[$key]['soil9'] > 0)
                {
                    $price9 = $basket[$key]['soil9'] * $data['soil9p'];
                    echo '<tr><td>' . $data['soil9'] . '</td><td>' . $basket[$key]['soil9'] . '</td><td> $' . $data['soil9p'] . '</td><td> $' . $price9 . '</td></tr>';
                }
